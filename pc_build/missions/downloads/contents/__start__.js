function bootAd(width, height) {window.game = {};(function() {
    // Shared Lib
    ...
    var pcBootstrap = {
        ...
        createCanvas: function () {
            ...
            document.querySelector("#creative").appendChild(canvas);
...
(function () {
    ...
    var configureCss = function (fillMode, width, height) {
        ...
        // append css to style
        cssElement=document.createElement("style"),cssElement.innerHTML=css,document.head.appendChild(cssElement);
    };
    ...
    var configure = function () {
        app.configure(CONFIG_FILENAME, function (err) {
            ...
            setTimeout(function () {
                ...
                window.game.resize=pcBootstrap.reflowHandler;
